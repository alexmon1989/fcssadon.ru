	...
	<fieldset>		
		<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::select('category_id',  Input::post('category_id', isset($article) ? $article->category_id : NULL), $categories, array('class' => 'col-md-4 form-control')); ?>            
		</div>
            
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <?php echo Form::checkbox('on_main_page', 1, Input::post('on_main_page', isset($article) ? $article->on_main_page : FALSE)); ?> На главной
                        </label>
                    </div>
                </div>
