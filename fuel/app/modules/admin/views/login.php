		...
		<?php echo Form::open(array()); ?>
			...
			<div class="form-group <?php echo ! $val->error('email') ?: 'has-error' ?>">
				...
				<?php if ($val->error('email')): ?>
					<span class="control-label"><?php echo $val->error('email')->get_message('Вы должны заполнить это поле'); ?></sőan>
				<?php endif; ?>
			</div>
			...
			<div class="actions">
				<?php echo Form::submit(array('value'=>'Вход', 'name'=>'submit', 'class' => 'btn btn-lg btn-primary btn-block')); ?>
			</div>
