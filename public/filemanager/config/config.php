...
$upload_dir = '/assets/img/uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../assets/img/uploads/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../assets/img/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
